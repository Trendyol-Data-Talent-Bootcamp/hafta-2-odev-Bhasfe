...
when not matched by source then
    update set t.is_deleted = True, t.cdc_date = current_timestamp()
...
from `dsmbootcamp.baris_hasdemir.content_category_20201222_00_59` as s join `dsmbootcamp.baris_hasdemir.content_category_target` as t on s.id = t.id
